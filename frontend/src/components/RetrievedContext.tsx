...
const RetrievedContext: React.FC<RetrievedContextProps> = ({ retrievedContext }) => {
  ...
  return (
    <div 
      className="w-full max-w-full mt-4 sm:mt-6"
    ...
    >
      <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 w-full max-w-full">
        ...
        <div className="rounded-lg p-4 sm:p-6" style={{background: 'linear-gradient(135deg, rgba(255, 255, 255, 0.02), rgba(255, 255, 255, 0.01))', backdropFilter: 'blur(32px)', WebkitBackdropFilter: 'blur(32px)', border: '1px solid rgba(255, 255, 255, 0.06)', boxShadow: '0 1px 2px rgba(0, 0, 0, 0.05), 0 2px 8px rgba(0, 0, 0, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.03)'}}>
          <button 
          ...
          {isOpen && (
            <div className="max-h-80 overflow-y-auto scrollbar-premium space-y-3">
