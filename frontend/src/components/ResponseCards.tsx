...
const ResponseCards: React.FC<ResponseCardsProps> = ({
  ...
  return (
    <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 w-full max-w-full lg:items-start">
      ...
      <div
        className="rounded-lg p-4 sm:p-6 lg:p-8 min-h-[400px] sm:min-h-[500px] lg:min-h-[600px] max-h-[70vh] sm:max-h-[75vh] lg:max-h-[80vh] flex flex-col w-full overflow-x-hidden"
        style={{
          background:
      ...
      >
        <div className="flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-6">
          <div
            className="w-8 h-8 rounded bg-gradient-to-br from-gray-400 to-gray-600 flex items-center justify-center flex-shrink-0"
            style={{
              boxShadow:
          ...
          <div>
            <h2
              className="text-premium-sm sm:text-premium-base font-semibold text-white"
              style={{ letterSpacing: "-0.025em" }}
            >
              Standard Response
            </h2>
            <p
              className="text-[10px] sm:text-premium-xs text-white/65 font-medium"
        ...
        <div className="border-t border-white/10 pt-4 sm:pt-6 flex-1 overflow-hidden relative">
          <div 
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 1px 2px rgba(0, 0, 0, 0.05), 0 2px 8px rgba(0, 0, 0, 0.1), 0 0 0 1px rgba(0, 210, 106, 0.05), inset 0 1px 0 rgba(255, 255, 255, 0.03)",
          transition: "all 0.4s cubic-bezier(0.16, 1, 0.3, 1)",
        }}
      >
        <div className="flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-6">
          <div
            className="w-8 h-8 rounded bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center flex-shrink-0"
            style={{
              boxShadow:
                "0 2px 4px rgba(0, 210, 106, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.2)",
            }}
          >
            <svg
              width="16"
          ...
          <div>
            ...
            <p
              className="text-[10px] sm:text-premium-xs text-green-400/90 font-medium"
              style={{ letterSpacing: "-0.01em" }}
            >
                            ...
                            return (
                              <button
                                ...
                                style={{
                                  fontSize: "inherit",
                                  background:
                                    "linear-gradient(135deg, rgba(0, 210, 106, 0.08), rgba(0, 210, 106, 0.12))",
                                  ...
                                  boxShadow:
                                    "inset 0 1px 0 rgba(0, 210, 106, 0.1)",
                                }}
                              >
                                {part}
                              </button>
